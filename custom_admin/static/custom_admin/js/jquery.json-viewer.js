...
(function ($) {
    ...
    function collapseAll(expandableElement) {
        collapseLevel(expandableElement);
    }
    ...
    function collapseLevel(expandableNodeElement, depth) {
        // if depth is not provided -> collapse all levels

        if (!( typeof depth === 'number' && depth <= 0 )) {
            getExpandableChildNodes(expandableNodeElement).each(function () {
                collapseLevel($(this), typeof depth !== 'undefined' ? depth - 1 : depth);
    ...
    $.fn.jsonPresenter = function (options) {
        if (options && typeof options === 'object') {
            ...
            return this.each(function () {
                collapseLevel(getRootNode($(this)), depth);
            });
